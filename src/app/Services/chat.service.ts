...
export class ChatService {
   ...
   readonly POST_URL = "http://localhost:5294/api/chat/SendMessage"
...
//  }
  ...
  {
    return this.http.post<ChatDTO>(`http://localhost:5294/api/chat/SendMessage`,chatDTO);
  }

  public GetConversation( UserId?:string ):Observable<Ichat[]>
  {

    return this.http.get<Ichat[]>(`http://localhost:5294/api/chat/GetMessage?sender=${UserId}&reciver=${this.auth.gettokenID()}`);
  }
